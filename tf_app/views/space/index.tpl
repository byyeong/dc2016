<!-- rowContent -->
<div class="rowContent" id="floor"> 

    <div class="page-header">
        <div class="container">
            <h2><a href="#"> Room Sharing</a></h2>
        </div>
    </div>
    <!-- /page-header -->
    ...
    <div class="page-content"> 
        ...
        <div class="container">  
            ...
            <div class="full-content floor-desc "> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2 text-center">
                        ...
                        <button class="btn btn-default btn-primary" onclick="javascript:location.href='#floor-formApply'">공간공유 신청하기</button>
                        {:}
                        <button class="btn btn-default btn-primary" onclick="javascript:alert('공간공유 신청 권한이 없습니다.'); return false;">공간공유 신청하기</button>
                        {/}
                    </div>
                </div>
                <!-- /floor-desc -->
            ...
            <div class="floor-status" id="floor-status">
                <h3><span class="icon-reorder "></span> 공간공유 현황</h3>
                <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled">
                                            ...
                                            {@ ..event}
                                            <li> <strong data-placement="top" data-toggle="popover" data-content="<img src='{..user.picture}' style='width: 30px;'> {..user.name}님{? ...cnt} / {...cnt}명{/}">{...purpose}</strong> <span class="time"><span class="icon icon-time"></span> {...start}~{...end}</span> </li>
                    ...
                    <!-- /table -->
                    <ul class="pager">
                        <li><a href="/space/{date}/1#floor-status"><span class="icon-chevron-left"></span></a></li>
                        <li><a href="/space/{date}/2#floor-status"><span class="icon-chevron-right"></span></a></li>
                    </ul>
              </div>  
              <!-- /floor-status -->
                     
                
            <div class="editor floor-formApply" id="floor-formApply">
                <div class="edit-header">
                     <h3><span class="icon-edit"></span> 공간공유 신청하기 </h3>
                </div> 
            
                <div class="edit-body" id="applyE_res" {? !ok}style="display: none;"{/}>
                    <div class="complete text-center"> 
                        <h4><span class="icon icon-smile icon-large"></span>&nbsp;  신청완료!!</h4>
                        <div class="well">
                            <p>공간공유 신청이 완료되었습니다. 개인 액티비티에서 확인 가능합니다.</p>
                            <div><a href="/" class="btn btn-default">홈으로</a></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-horizontal">
                        <p>
                            <span class="icon-stack pull-left">
                                ...
                                <span class="icon-share-alt icon-light"></span>
                            </span>  
                            D.CAMP는 미팅, 회의, 행사 등 여러 목적으로 사용되는 공간을 공유하고 있습니다. <br>
                            아래의 목적을 선택후 해당 내용을 입력해주세요.
                        </p> 
                                                   
<!-- form-rentalRoom -->
                        <div id="form-rentalRoom" class="form-group-wrap">
                            <form name="space_r2_form" class="form-horizontal" id="space_r2_form" method="post" action="/space/reserve" onsubmit="return false;">
                                ...
                                <div class="form-group form-submit">
                                    <div class="col-xs-12 col-sm-offset-2 col-md-offset-2 col-sm-10 col-md-10">
                                        ...
                                        <button class="btn btn-primary" type="submit" onclick="submit_space_r('space_r2_form', 2); return false;">신청</button>
                                    </div>
                                </div>
                                </fieldset>
                            </form>
                    ...
                    <div class="alert alert-warning text-center">
                        <p>공간공유는 '<a href="http://dcamp.kr/membership">멤버십 회원</a>'만 가능합니다. 지금 바로 <a href="http://dcamp.kr/membership">멤버십 회원</a>으로 신청해 보세요. </p>
                    </div>
                    {/}
                    {:}
                    <div class="alert text-center">
                        <p>공간공유 신청은 디캠프 회원에게 제공됩니다. <br>이미 가입하셨다면 로그인 후 진행해주세요.</p><br>
