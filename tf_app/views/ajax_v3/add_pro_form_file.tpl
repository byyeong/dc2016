<div class="ui-state-default  rounded entry-itemOption pro_form_f"> 
    {? ress}
        ...
        <fieldset>  
            ...
            <div class="action-wrap">
                <div class="col-sm-offset-2 col-md-offset-2">  
                    <button  class="btn btn-info btn-sm" onclick="add_pro_form_file(this, {? ress}1{:}0{/}, '{ress.program_id}'); return false;">저장</button> 
                </div>
            </div>
