                ...
                <section>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="actions"> <span class="break"></span> <a title="심사위원 목록보기" data-toggle="tooltip" href="/admin_challenge/examiner_list"><span class="glyphicon  glyphicon-align-justify"></span></a> </div>
                        </div>
                        <!-- /panel-heading -->
                        
                        <form class="form-horizontal" method="post" role="form" name="invitation_f" action="/admin_challenge/examiner_add">
...
안녕하세요. 은행권청년창업재단 D.CAMP입니다.

D.CAMP Challenge의 심사위원단으로 초대드립니다. 

심사위원단 참여를 수락해주시면 Challenge 플랫폼을 이용하여 진행되는 경진대회의 심사위원 후보로 자동 추천되어 쉽게 심사위원으로 참여하실 수 있습니다.

개별 경진대회에서 심사위원으로 초빙할 경우, 별도의 메일로 다시 안내 드립니다.
