...
<div id="regist-startup" class="content"> 
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2"> 
            ...
            <!-- header -->
            <div class="header">
                <h1><a href="/"><img src="/img/logo.png" alt="D.CAMP"></a> <small>창업유관기관</small></h1>
            </div>
            <!-- /header --> 
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><span class="icon-building"></span> 창업유관기관 연결하기</h2>
                </div>
                <div class="panel-body">
                
                    <div class="guide-wrap">
                        <p>소속되어 있는 창업유관기관 정보를 입력하면 개인정보와 연계되어 포트폴리오로 활용이 가능합니다. <br>
                        ...
                        <form class="form-horizontal" role="form">
                            <fieldset> 
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="창업유관기관 이름을 입력해 주세요" id="search">
...
function search_startup(){
    var key = $('#search').val();
    var get_url = '/ajax_front/get_search_investment/';
    var set_data ={
        "data" 		: key,
    };
