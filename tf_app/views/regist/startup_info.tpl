...
<div id="regist-startup" class="content"> 
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2"> 
            ...
            <!-- header -->
            <div class="header">
                <h1><a href="/"><img src="/img/logo.png" alt="D.CAMP"></a> <small>스타트업</small></1>
            </div>
            <!-- /header --> 
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><span class="icon-building"></span> 스타트업 등록하기</h2>
                </div> 
                <form class="form-horizontal" role="form" name="regist_st" action="/regist/startup_entered" method="post">
                    <input type="hidden" name="stype" value="1" />
                    <fieldset>
                        <div class="panel-body">
                        
                            <div class="form-group">
                                <div class="col-sm-4 col-md-3 control-label">회사명</div>
                                <div class="col-sm-8 col-md-9">  
                                    <input type="text" class="form-control" placeholder="회사명" name="name" value="{name}" > 
                                </div>
                            </div>
                            <!-- /form-group -->
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-md-3 control-label">사업분야</div>
                                <div class="col-sm-8 col-md-9">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-md-3 control-label">핵심기술</div>
                                <div class="col-sm-8 col-md-9">
