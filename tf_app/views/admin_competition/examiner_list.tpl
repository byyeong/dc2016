                ...
                <section>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="actions"> <span class="break"></span> <a title="심사위원 추가" data-toggle="tooltip" href="/admin_competition/examiner_add"><span class="glyphicon  glyphicon-plus"></span></a> </div>
                        </div>
                        <!-- /panel-heading -->
                        ...
                        <div class="panel-footer">
                            <div class="paging">
                                <ul class="pagination">
                                    ...
                                    {:}
                                    <li><a href="/admin_competition/examiner_list/{page - 1}">&laquo;</a></li>
                                    {/}
                                    ...
                                    {:}
                                    <li {?.type == "current"}class="active"{/}><a href="/admin_competition/examiner_list/{.page}">{.page}</a></li>
                                    {/}
                                    {/}
                                    ...
                                    {:}
                                    <li><a href="/admin_competition/examiner_list/{page + 1}" >&raquo;</a></li>
                                    {/}
                                </ul>
                            </div>
                        </div>
