                ...
                <section>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="actions"> <span class="break"></span> <a title="경진대회 추가" data-toggle="tooltip" href="/admin_competition/edit"><span class="glyphicon  glyphicon-plus"></span></a> </div>
                        </div>
                        <!-- /panel-heading -->
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-subject"><a href="/admin_competition/edit/{.id}">{.subject}</a></td>
                                    ...
                                    {/}
                                    <td class="td-status">
                                        {? .status == 0}<button onclick="location.href='/admin_competition/edit/{.id}'" class="btn btn-default btn-xs" type="button">승인대기</button>{/}
                                        {? .status == 1}<button onclick="location.href='/admin_competition/edit/{.id}'"  class="btn btn-success btn-xs" type="button">승인</button>{/}
                                        {? .status == 2}<button onclick="location.href='/admin_competition/edit/{.id}'"  class="btn btn-warning btn-xs" type="button">반려</button>{/}
                                    </td>
                                </tr>
                                {/}
                            </tbody>
                        ...
                        <div class="panel-footer">
                            <div class="paging">
                                <ul class="pagination">
                                    ...
                                    {:}
                                    <li><a href="/admin_competition/{page - 1}?order={order}">&laquo;</a></li>
                                    {/}
                                    ...
                                    {:}
                                    <li {?.type == "current"}class="active"{/}><a href="/admin_competition/{.page}?order={order}">{.page}</a></li>
                                    {/}
                                    {/}
                                    ...
                                    {:}
                                    <li><a href="/admin_competition/{page + 1}?order={order}" >&raquo;</a></li>
                                    {/}
                                </ul>
                            </div>
                        </div>
...
$(document).ready(function(){ 
    ...
    { 
        ...
        document.location.href = "/admin_competition?order="+_val;
    }); 
}); 
