                ...
                <div class="content col-xs-12 col-sm-12 col-md-9">
                    <div class="content-header">                       
                        <h3 class="content-heading"> <span class="icon-map-marker"></span> 디자인 라운지 예약 내역 </h3>
                    </div>
                    {? res} 
                    ...
                    <div class="paging text-center">
                        <ul class="pagination" style=" margin: 0;">
                            ...
                            {:}
                            <li><a href="/member/edit_rsv2/{page - 1}">&laquo;</a></li>
                            {/}
                            ...
                            {:}
                            <li {?.type == "current"}class="active"{/}><a href="/member/edit_rsv2/{.page}">{.page}</a></li>
                            {/}
                            {/}
                            ...
                            {:}
                            <li><a href="/member/edit_rsv2/{page + 1}" >&raquo;</a></li>
                            {/}
                        </ul>
                    </div>
                    <!-- /paging -->
