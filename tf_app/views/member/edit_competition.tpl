            ...
            <div class="col-xs-12 col-sm-12 col-md-9 content">
                <div class="content-header">                    
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="/member/edit_competition"><span class="icon-fixed-width  icon-edit "></span> 참가한 경진대회</a>
                        </li>
                        {? make} 
                        <li><a href="/member/edit_competition_m"><span class="icon-fixed-width icon-pencil"></span> 개최한 경진대회</a>
                        </li>
                        {/}
                        {? examine} 
                    ...
                    <div class="tab-pane active" id="applied">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="td-manage"><a href="/competition/apply/{.id}/{.caid}" class="btn btn-default btn-xs">내용보기</a> {? date('Y.m.dH:i') > .sdate && date('Y.m.dH:i') < .edate}<a href="/competition/apply/{.id}/{.caid}" class="btn btn-default btn-xs">수정</a>{/} </td>
                                    <td class="td-status"> 
                        ...
                        <div class="paging text-center">
                            <ul class="pagination" style=" margin: 0;">
                                ...
                                {:}
                                <li><a href="/member/edit_competition/{page - 1}">&laquo;</a></li>
                                {/}
                                ...
                                {:}
                                <li {?.type == "current"}class="active"{/}><a href="/member/edit_competition/{.page}">{.page}</a></li>
                                {/}
                                {/}
                                ...
                                {:}
                                <li><a href="/member/edit_competition/{page + 1}" >&raquo;</a></li>
                                {/}
                            </ul>
                        </div>
                        <!-- /paging -->
                        ...
                        <div class="alert alert-info">
                            ...
                            <p>
                                <button class="btn btn-primary btn-sm" onclick="javascript:document.location.href='/?c=competition'"><span class="icon-fixed-width icon-large icon-reorder"></span> 경진대회 보기</button>
                            </p>
                        </div>
                        {/} 
                    </div>
