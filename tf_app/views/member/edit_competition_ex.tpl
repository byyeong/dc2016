            ...
            <div class="col-xs-12 col-sm-12 col-md-9 content">
                <div class="content-header">                    
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        {/}
                        {? examine || st} 
                        <li class="active"><a href="/member/edit_competition_ex"><span class="icon-fixed-width  icon-check "></span> 심사위원 위촉 경진대회</a>
                        </li>
                        {/} 
                    </ul>
                </div>
                    ...
                    <div class="tab-pane active" id="examined">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="td-applier"> <a href="/competition/applied_list/{.id}"><span class="badge badge-primary">{.apply_cnt} <i class="icon-caret-right"></i></span></a> </td>
                        ...
                        <div class="paging text-center">
                            <ul class="pagination" style=" margin: 0;">
                                ...
                                {:}
                                <li><a href="/member/edit_competition_ex/{page - 1}">&laquo;</a></li>
                                {/}
                                ...
                                {:}
                                <li {?.type == "current"}class="active"{/}><a href="/member/edit_competition_ex/{.page}">{.page}</a></li>
                                {/}
                                {/}
                                ...
                                {:}
                                <li><a href="/member/edit_competition_ex/{page + 1}" >&raquo;</a></li>
                                {/}
                            </ul>
                        </div>
                        <!-- /paging -->
