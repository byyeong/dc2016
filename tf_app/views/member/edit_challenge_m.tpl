            ...
            <div class="col-xs-12 col-sm-12 col-md-9 content">
                <div class="content-header">                    
                    ...
                    <ul class="nav nav-tabs">
                        {? make} 
                        <li class="active"><a href="/member/edit_challenge_m"><span class="icon-fixed-width icon-pencil"></span> 개최한 경진대회</a>
                        </li>
                        {/}
                        {? op} 
...
{? msgt}
_m = "Challenge 개설 신청이 잘 접수되었습니다.<br><br>신청 내용은 승인 후 상세 정보를 입력하실 수 있습니다.<br>승인은 최대 48시간이 소요됩니다.<br><br>빠른 승인 필요하신 경우에는 Support 메뉴를 통해 문의 부탁드립니다.";
