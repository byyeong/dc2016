                ...
                <section> 
                    ...
                    <div id="pane-main-listset" class="panel panel-default"> 
                        ...
                        <div class="panel-heading">
                            <h2><span class="glyphicon  glyphicon-cog"></span><span class="break"></span> Showcase 키비주얼 관리 <small> 사이즈는 670x182 이상입니다.</small></h2> 
                        </div>
                        <!-- /panel-heading -->
                        <form class="form-horizontal" method="post" action="/admin_showcase/edit_pic">
                            ...
                            <div class="panel-body">  
                                <fieldset>
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-xs-12 col-sm-2 col-md-2 control-label" >Link</div>                                        
                                        <div class="col-xs-12 col-sm-10 col-md-10"> 
                                            <input type="text" class="form-control" name="des_3" value="{res.des_3}" placeholder="키비주얼 클릭시 이동할 url을 입력해주세요." >
                                        </div>
                                    </div>
                                    <!-- /form-group -->
                                </fieldset>
