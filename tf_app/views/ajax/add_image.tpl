...
<link type="text/css" rel="stylesheet" href="/css/su_admin.css" />

</head>
<body id="popBody">

<div class="imgUpWrap">
    <form method="post" enctype="multipart/form-data" name="attach_image_pop" action="/ajax/add_image_process">
