        ...
        $(document).ready(function() {
            $('#aboutDcamp').fullpage({
                ...
                afterLoad: function(anchorLink, index){
                    ...
                    if($(loadedSection[0]).attr('id') == 'activity'){
...
<section class="section" id="intro">
    <div id="go-main" class="container-flud">
        <a href="/" target="_self"><span class="glyphicon glyphicon-arrow-left"> dcamp.kr</a>
    </div>
    <div class="container">
        <div class="row">
                ...
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/network/people">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.member}</span></dd>
                        </dl>
                </div>
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/membership">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.membership}</span></dd>
                        </dl>
                    </a>
                </div>
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/network/startup">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.startup}</span></dd>
                        </dl>
                    </a>
                </div>
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/reservation">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.reservation}</span></dd>
                        </dl>
                    </a>
                </div>
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/office_hours">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.office_hours}</span></dd>
                        </dl>
                    </a>
                </div>
                <div class="item col-xs-4 col-sm-4 col-md-2">
                    <a href="http://dcamp.kr/challenge">
                        <dl>
                            ...
                            <dd><span class="counter">{activity.competitions}</span></dd>
                        </dl>
                    </a>
                </div>
            </div>
                                    ...
                                    <div class="col-xs-6">
                                        <blockquote>
                                            <p>
                                                ...
                                                파트너사들과 후속 투자자들을 만날 수 있었습니다. 어려울 때 가장 먼저 생각나는 든든한 친구같습니다.
                                            </p>
                                            <footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <nav>
                        <ul class="pager">
                            <li><a href="#" class="prev" data-page="0">Previous</a></li>
                            <li><a href="#" class="next" data-page="2">Next</a></li>
                        </ul>
                    </nav>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.pager a').click(function(){
            ...
            var get_url = "/ajax_front/more_press2/"+page;
            $.post(get_url, function(_data) {
                if (_data !== '') {
                    $('.press-list').html(_data);
                    $('.pager .prev').data('page', parseInt(page)-1);
                    $('.pager .next').data('page', parseInt(page)+1)
                } else {
                    alert("마지막 페이지입니다.");
                }
            });
