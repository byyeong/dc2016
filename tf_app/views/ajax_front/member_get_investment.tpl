  ...
  $(function() {
    $( ".datepicker" ).datepicker({ dateFormat: 'yy.mm.dd' }).val();
                            ...
                            <div class="panel-heading">
                                <strong>관련기업/조직</strong>
                                {? s.id == id}
                                <button class="btn btn-default btn-xs" onclick="add_career(); return false;">Add </button>
                                {/}
                            </div>
                            <!-- /panel-heading --> 
                                ...
                                <ul class="item-list">
                                    <li class="item edit"> 
                                        ...
                                        <form class="form-edit-set" name="edit_career_form_0" id="edit_career_form_0" onkeydown="return captureReturnKey(event);">
                                            ...
                                            <fieldset>
                                                <button type="button" class="close" data-toggle="tooltip" data-placement="top" title="닫기" onclick="add_career(this); returfalse;">&times;</button>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button onclick="find_com(this, 2); return false;" class="btn btn-default" type="button" ><span class="glyphicon glyphicon-search"></span><span class="sr-only">검색</span></button>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>                          
                                                ...
                                                <div class="form-group form-submit">
                                                    <button class="btn btn-primary btn-sm" onclick="submit_inv(this, 0); return false;">Save</button>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </li>
                                    ...
                                    <li class="item edit" style="display: none;"> 
                                        ...
                                        <form class="form-edit-set" name="edit_career_form_{.id}" id="edit_career_form_{.id}" onsubmit="return false;">
                                            ...
                                            <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button onclick="find_com(this, 2); return false;" class="btn btn-default" type="button" data-toggle="modal" href="#md-searchStartup"><span class="glyphicon glyphicon-search"></span><span class="sr-only">검색</span></button>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group form-submit">
                                                    <button class="btn btn-primary btn-sm" onclick="submit_inv(this, '{.id}'); return false;">저장하기</button>
