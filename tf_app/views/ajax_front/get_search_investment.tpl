    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="well search-form">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button data-toggle="modal" href="#searchStartup" class="btn btn-default" onclick="search_startup_in(); return false;"><span class="icon-search"></span><span class="sr-only">검색하기</span></button>
                        </span> 
                     </div>
                </div>
                <!-- /search-input -->  
                ...
                <div class="search-result">
                    ...
                    <div class="list-result"> 
                            <ol class="list-unstyled">
                                {@ res}
                                <li><a href="/regist/investment_connected/{.id}/{user_id}">{.name} <span class="label label-default pull-right">선택</span></a></li>
                                {/}
                            </ol> 
                    </div>
                    <!-- /list-result -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="javascript:location.href='/regist/investment_info'">확인</button>
            </div>
            <!-- /modal-footer --> 
        </div>
        <!-- /.modal-content --> 
...
function search_startup_in(){
    ...
    var get_url = '/ajax_front/get_search_investment_in/';
    var set_data ={
        "data" 		: key,
    };
