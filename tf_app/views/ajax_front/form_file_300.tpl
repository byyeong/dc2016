...
.cuttingArea { width: 780px; overflow: hidden; }
...
<body>
	...
	{? strlen(large_photo_exists) > 0}
        ...
        <div class="btnwrap">
            <button type="submit" class="submit btn_image_save" name="upload_thumbnail" id="save_thumb" /><span>{"미리보기의 사진을 저장합니다."}</span> </button>
        </div>
	{/}
	</div>
