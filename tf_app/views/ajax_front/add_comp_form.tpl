                                                    <div class="ui-state-default  rounded entry-itemOption comp_form_e" style="display: none;"> 
                                                        {? ress}
                                                        ...
                                                        <fieldset>  
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-xs-12 col-sm-10 col-md-10">
                                                                    <select class="selectpicker" data-width="auto" name="type" onchange="make_form(); return false;">
                                                            ...
                                                            <div class="form-group"> 
                                                                <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2">
                                                                    <div class="checkbox">
                                                                        <label>
                                                                            <input type="checkbox" name="required" {? ress.required}checked="checked"{/}>
                                                                            필수입력</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="action-wrap">
                                                                <div class="col-sm-offset-2 col-md-offset-2">  
                                                                    <button  class="btn btn-info btn-sm" onclick="add_comp_form(this, {? ress}1{:}0{/}); return false;">저장</button> 
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        </form>
