...
<li class="ui-state-default entry-item form-group"> 
    ...
    <div class="set-wrap pull-right">                                                            
        <button class="btn btn-default btn-xs edit" type="button" onclick="get_form_field_e(this); return false;"><span class="icon-edit"></span></button> 
        <button class="btn btn-default btn-xs delete" type="button" onclick="delete_form_sort(this); return false;"><span class="icon-trash"></span></button> 
    </div>
...
<li class="ui-state-default entry-item form-group"> 
    ...
    <input type="hidden" value="{@ res.opt}{.value_},{/}" class="opt" />
    <i class="icon-move pull-left"></i>
    <div class="set-wrap pull-right">                                                            
        <button class="btn btn-default btn-xs edit" type="button" onclick="get_form_field_e(this); return false;"><span class="icon-edit"></span></button> 
        <button class="btn btn-default btn-xs delete" type="button" onclick="delete_form_sort(this); return false;"><span class="icon-trash"></span></button> 
