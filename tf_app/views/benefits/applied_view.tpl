                ...
                <div  class="row"> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 content">
                        ...
                        <div class="content-header">
                            <h3 class="content-heading"><a href="/member/edit_benefit_m">Benefits 관리</a> > 운영 현황</h3> 
                        </div>
                        ...
                        <div class="applied-view panel panel-default"> 
                            <div class="panel-heading"> 
                                ...
                                <a class="btn btn-default btn-xs pull-right" href="/benefits/applied_list/{res.id}">프로그램 참가자 목록보기</a>
                                ...
                                <div class="answered">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            <a href="/benefits/get_source?aid={per.id}&fid={.fid}">{.val}</a>
                                            {/}
                                        </dd>
                                    </dl>
                                    {/}
