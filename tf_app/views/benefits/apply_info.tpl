...
$('#md-warning-ch .btn-danger').attr('onclick', 'javascript:location.href="/benefits/applied_list/{res.id}?tab=dashboard"');
...
//]]>
    ...
    <div class="rowContent"  id="competition"> 
        ...
        <!-- page-content -->
        <div class="page-content" id="program-edit"> 
            <!-- container -->
            <div class="container">
                <div class="editor">
                    ...
                    <div class="edit-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li><a href="/benefits/edit/{res.id}">{? res}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}신청 정보 입력</a></li>
                            <li class="active"><a href="/benefits/apply_info/{res.id}">{? res.basic || res.forms || res.form_file}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}지원서 만들기</a></li>
                        </ul>   
...
<div class="modal fade" id="md-takeprogram" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
</div>
<!-- /modal #md-searchMember -->