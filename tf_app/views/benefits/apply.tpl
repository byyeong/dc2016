                ...
                <div  class="row"> 
                        ...
                        <div class="applied-item well">
                            <div class="media"> 
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="/benefits/views/{res.id}">{res.title}</a></h4>
                        ...
                        <div class="editor">
                            <div class="edit-body">
                                {? (date('Y.m.d H:i') > res.a_start && date('Y.m.d H:i') < res.a_end) || pre || !res.a_start}
                                    ...
                                    <form  role="form" name="apply_f" action="/benefits/save_apply" method="post" enctype="multipart/form-data" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {? .val}
                                        <a href="/benefits/get_source?aid={per.id}&fid={.fid}">[업로드된 파일 다운로드]</a>
                                        {/}
                                        <div class="file">
                                    ...
                                    <div class="form-actions text-center">
                                        <button type="button" class="btn btn-default" onclick="location.href='/benefits/views/{res.id}'">취소</button>
                                ...
                                <div class="alert alert-info text-center">
                                    ...
                                    <a class="btn btn-default btn-sm" href="/benefits">경진대회 리스트 보기</a>
                                </div>
                                {/}
                                {/}
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        <div class="panel recentporst">
                            <h3 class="panel-title">Recent Benefit</h3>
...
//<![CDATA[
    ...
    function del_apply()
    {
        window.location.href="/benefits/apply/{res.id}/{per.id}?req=del";
    }
