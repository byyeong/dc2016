SNS 샘플 - 트위터 연동<br />
<br />
/tf_sns_utils/twitter_auth/ 를 링크하는 것으로 연동이 시작됩니다.<br /><br />
다만,<br />
tf_app/ext/tf_sns_utils/settings.php 파일에<br />
트위터에서 발급받은 cunsumer_key, cunsumer_secret, 그리고<br />
...
설정이 옳은 것이 확실하다면,
<a href="/tf_sns_utils/twitter_auth/">/tf_sns_utils/twitter_auth/</a> 로 이동합니다.
<br />
