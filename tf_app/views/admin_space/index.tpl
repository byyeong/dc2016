                ...
                <section> 
                    ...
                    <div class="panel panel-default"> 
                        ...
                        <div class="panel-heading">
                            <h2><span class="glyphicon  glyphicon-align-justify"></span><span class="break"></span> 공간 예약 목록</h2>
                            <div class="actions"> 
                                <span class="break"></span> <a title="" data-toggle="tooltip" class="btn-add" href="/admin_space/reserve" data-original-title="공간공유 추가"><span class="glyphicon  glyphicon-plus"></span></a> 
                                <span class="break"></span><a data-original-title="다운로드" href="/admin_space/excel" class="btn-down" data-toggle="tooltip" title=""><span class="glyphicon glyphicon-download-alt"></span> Excel</a>
                            </div>
                        </div>
                        <!-- /panel-heading -->
                                    ...
                                    <th class="td-status" width="140" >
                                        <select class="selectpicker" data-width="auto" name="type">
                                            <optgroup label="공간구분">
                                                ...
                                                <option value="3" {? type == 3}selected="selected"{/}>디자인 라운지</option>
                                            </optgroup>
                                        </select>
                                    </th>
