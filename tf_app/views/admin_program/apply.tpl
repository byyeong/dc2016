                ...
                <div  class="row"> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 content"> 
                        ...
                        <div class="applied-item well">
                            <div class="media"> 
                                {? res.img}<a href="/admin_program/views/{res.id}" class="pull-left media-object"><img class="img-responsive" src="{res.img}" ></a>{/}
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="/admin_program/views/{res.id}">{res.title}</a></h4>
                        ...
                        <div class="editor">
                            <div class="edit-body">
                                {? (date('Y.m.d H:i') > res.a_start && date('Y.m.d H:i') < res.a_end) || pre}
                                 
                                    <form  role="form" name="apply_f" action="/admin_program/save_apply" method="post" enctype="multipart/form-data" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {? .val}
                                        <a href="/admin_program/get_source?file={.val}">[업로드된 파일 다운로드]</a>
                                        {/}
                                        <div class="file">
                                    ...
                                    <div class="form-actions text-center">
                                        <button type="button" class="btn btn-default" onclick="location.href='/admin_program/views/{res.id}'">취소</button>
                                ...
                                <div class="alert alert-info text-center">
                                    ...
                                    <a class="btn btn-default btn-sm" href="/admin_program">경진대회 리스트 보기</a>
                                </div>
                                {/}
                                {/}
...
//<![CDATA[
    ...
    function del_apply()
    {
        window.location.href="/admin_program/apply/{res.id}/{per.id}?req=del";
    }
