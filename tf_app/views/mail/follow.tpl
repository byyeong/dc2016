            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="color:#999; text-align: center;"> 
                        <h3 style="text-transform: uppercase; font-weight:bold; font-family: 'Malgun Gothic', 'open sans', Arial, sans-serif;  font-size: 40px; margin:0 ;">People</h3>
                     </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 20px 0;"> 
                        <h4 style="font-size: 16px; font-weight:bold; text-align: center; color:#666; margin-top:0;" >{res.name}님이 회원님을 Follow하였습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            ...
                            <tr>
                                <td width="100" valign="top">
                                    <img src="{? preg_match("/^http(s)?:\/\//",res.picture)}{res.picture}{:}http://dcamp.kr{res.picture}{/}" style="width:100px;"> 
                                    
                                </td>
                                <td valign="top">
                                    <h3 style=" font-size:18px; margin-top:0; margin-bottom: 10px;">{res.name} <small>({res.ids})</small></h3>
                                    <p>{=htmlspecialchars(res.bio)}</p>
                                </td>
                            </tr>
                        </table>   
                                             
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/member/{res.ids}" style="display: inline-block; font-size:12px; line-height:1; padding:14px 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">프로필 보러가기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
