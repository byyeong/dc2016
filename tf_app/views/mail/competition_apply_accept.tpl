            ...
            <table width="100%" align="center"  cellspacing="0" cellpadding="0" border="0"  style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;">
                        <h4 style="font-size:18px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{aly.name}님의 경진대회 참가신청이 {?aly.status == 1}접수{/}{?aly.status == 2}반려{/}되었습니다.</h4>
