...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:14px; font-family: 'Malgun Gothic', Arial, sans-serif; ">
            ...
            <table width="100%" align="center"  cellspacing="0" cellpadding="0" border="0"  style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;">
                        <h4 style="font-size:18px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{user.name}님이 신청하신 경진대회의 수상자가 발표되었습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                        ...
                        <p>신청하신 위의 경진대회에 {res.name}님이 경진대회의 수상자로 선정되었습니다. 자세한 내용은 아래의 버튼을 클랙해서 확인해주세요.</p>
                        <br/>
                                             
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/challenge/views/{res.id}" style="display: inline-block;   line-height: 40px; padding:0 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;     -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">수상자 확인하기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
