...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:12px; font-family: 'Malgun Gothic', Arial, sans-serif;  ">
        ...
        <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;"> 
                        ...
                        <h4 style="font-size:16px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{wr.name}님이 {rc.name}님의 '타임라인'에 글을 작성하였습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            <tr>
                                <td>
                                    ...
                                    <table  width="100%" cellspacing="10" cellpadding="0" border="0" >
                                        <tr>
                                            <td width="40" valign="top"><img src="{? preg_match("/^http(s)?:\/\//", wr.picture)}{wr.picture}{:}http://dcamp.kr{wr.picture}{/}" style="width:40px; height:40px;"></td>
                                            <td valign="top"><strong style=" font-size:16px; margin-top:0; margin-bottom: 10px;">{wr.name}</strong>
                                                <p>{contents}</p>
                                        </tr>
                                    </table>  
                                  <!-- / post -->
                        ...
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/member/{rc.ids}" style="display: inline-block; font-size:12px; line-height:40px; padding:0 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">글 보러가기 &rarr;</a></p>
