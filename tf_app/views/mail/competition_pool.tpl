            ...
            <table width="100%" align="center"  cellspacing="0" cellpadding="0" border="0"  style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0 10px;">
                        <h4 style="font-size:18px; font-weight:bold;  color:#000;  text-align: center; margin-top:0;">DCAMP에서 경진대회 심사위원단으로 초대하였습니다.</h4>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding: 20px; text-align: center;">
                        <a href="http://dcamp.kr/challenge/pending_pool/{id}?e={e}" style="display: inline-block;  font-size: 12px; line-height: 40px; padding:0 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;     -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">심사위원 위촉 승인 또는 거절 &rarr;</a>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
