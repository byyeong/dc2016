...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:12px; font-family: 'Malgun Gothic', Arial, sans-serif; ">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; margin:0 auto; ">
                ...
                <!-- tr>
                    <td style="color:#999; text-align: center;"> 
                        <h3 style="text-transform: uppercase; font-weight:bold; font-family: 'Malgun Gothic', 'open sans', Arial, sans-serif;  font-size: 40px; margin:0 0 8px;">Membership</h3>
                        <font style="font-size: 12px;">복합 창업 생태계 허브 D.CAMP는 예비 창업자와 스타트업에게 다양한 혜택과 지원을 준비해 놓고 있습니다.</font>
                     </td>
                </tr --> 
                <tr>
                    <td style="padding: 20px 0;"> 
                        <h4 style="font-size: 16px; font-weight:bold; text-align: center; color:#666; margin-top:0;" > D.CAMP 방문을 환영합니다. </h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            <tr>
                                <td>
                                    <h4 style=" margin:0 0 10px;">멤버십 가입시 다음의 혜택을 이용하실 수 있습니다.</h4>
                                    <ul>
                                    ...
                                    <span style="font-size:11px; color:#888; margin-left:30px;">지금D.CAMP Lounge 를 통해 D.CAMP 에서 함께 큰 꿈을 만들어가고 있는 분들을 만나보세요.</span>
                                </td>
                            </tr> 
                        </table>   
                                             
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/lounge" target="_blank" style="display: inline-block; font-size:12px; line-height:40px; padding:0 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;"> D.CAMP Lounge 바로가기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
