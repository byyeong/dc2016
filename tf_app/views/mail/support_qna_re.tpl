...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:12px; font-family: 'Malgun Gothic', Arial, sans-serif; ">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; margin:0 auto; "> 
                <tr>
                    <td style="padding: 20px 0;"> 
                        <h4 style="font-size: 16px; font-weight:bold; text-align: center; color:#666; margin-top:0;" >작성하신 Q&A의 답변이 등록되었습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            <tr>
                                <td width="20%" align="right">작성자 명 :</td>
                                <td width="80%" align="left"><strong>{res.name}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">전화번호 :</td>
                                <td align="left"><strong>{res.tel}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">이메일 :</td>
                                <td align="left"><strong>{res.email}</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right">질문제목 :</td>
                                <td align="left"><strong>{res.title}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">질문내용 :</td>
                                <td align="left"><strong>{=add_brs(res.content)}</strong></td>
                            </tr>
                        </table>   
                        <br>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            <tr>
                                <td width="20%" align="right">담당자 명 :</td>
                                <td width="80%" align="left"><strong>{s.name}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">질문답변 :</td>
                                <td align="left"><strong>{=add_brs(ans.content)}</strong></td>
                            </tr>
                        </table>
                                             
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/support/views/{res.id}" style="display: inline-block; font-size:12px; line-height:1; padding:14px 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">Q&A 확인하기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
