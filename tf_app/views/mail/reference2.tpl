        ...
        <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;"> 
                        ...
                        <h4 style="font-size:16px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{res.name}님이 {req.name}님의 '레퍼런스'에 글을 작성하였습니다.</h4>
