        ...
        <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;"> 
                        ...
                        <h4 style="font-size:16px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{title}</h4>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table  width="100%" cellspacing="10" cellpadding="0" border="0" >
                                        <tr>
                                            <td width="40" valign="top"><img src="{? preg_match("/^http(s)?:\/\//", rc.picture)}{rc.picture}{:}http://dcamp.kr{rc.picture}{/}" style="width:40px; height:40px;"></td>
                                            <td valign="top"><strong style=" font-size:16px; margin-top:0; margin-bottom: 10px;">{rc.name}</strong>
                                                <p>{=add_brs(content)}</p>
                                        </tr>
                                    </table>  
                                  <!-- / post -->
