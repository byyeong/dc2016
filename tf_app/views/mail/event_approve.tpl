...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:12px; font-family: 'Malgun Gothic', Arial, sans-serif; ">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;"> 
                        <h4 style="font-size:16px; font-weight:bold; text-align: center; color:#666; margin-top:0;" >{res.mname}님의 이벤트가 {? res.state == 1}<span style="color:#428BCA;">승인</span>{:}<span style="color:#D9534F;">반려</span>{/}되었습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            {? res.state == 2 && res.state_des}
                            <tr>
                                <td width="20%" align="right">반려사유 :</td>
                                <td width="80%" align="left" style="color: #D9534F;"><strong>{res.state_des}</strong></td>
                            </tr> 
                            {/}
                            <tr>
                        ...
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/event/apply/{res.id}" style="display: inline-block; font-size:12px; line-height:1; padding:14px 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;     -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">이벤트 확인하기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
