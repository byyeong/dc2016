...
<table width="100%" cellspacing="10" cellpadding="0" border="0" style="background-color: #f6f6f6; border-top:2px solid #eee; font-size:14px; font-family: 'Malgun Gothic', Arial, sans-serif; ">
            ...
            <table width="100%" align="center"  cellspacing="0" cellpadding="0" border="0"  style="max-width:600px; margin:0 auto; ">
                ...
                <tr>
                    <td style="padding:20px 0;">
                        <h4 style="font-size:18px; font-weight:bold;  color:#666;  text-align: center; margin-top:0;">{res.name}님의 Benefit 프로그램이 {?res.status == 1}승인{/}{?res.status == 2}반려{/}되었습니다.</h4>
    ...
    -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); ">
                            <tr>
                                <td width="20%" align="right">프로그램명 :</td>
                                <td width="80%" align="left"><strong>{res.title}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">지원기관 :</td>
                                <td align="left"><strong>{res.agency}</strong></td>
                            </tr>
                            <tr>
                                <td align="right">참가 접수 기간 :</td>
                                <td align="left"><strong>{? res.a_start}{=date_to_kr(res.a_start)} ~ {=date_to_kr(res.a_end)}{:}상시{/}</strong></td>
                            </tr>
                            {? res.status == 2 && res.status_des}
                            <tr>
                                <td align="right" valign="top">반려사유 :</td>
                                <td align="left" style=" color: #ff7800;">{res.status_des}</td>
                            </tr>
                            {/}
                        </table>  
                                             
                        <p style="text-align: center; margin:20px 0 0;"> <a href="http://dcamp.kr/member/edit_benefit_m" style="display: inline-block;   line-height: 40px; padding:0 20px; background-color:#FF7800; color:#fff; border:1px solid #f75d00; border-radius: 4px;     -moz-border-radius: 4px;  -webkit-border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);    -moz-box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05);  text-decoration: none;">스타트업 지원 프로그램 보러가기 &rarr;</a></p>
                    </td>
                </tr>
                <!-- /E -->   
                <tr>
