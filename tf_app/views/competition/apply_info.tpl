                ...
                <div class="editor">
                    <div class="edit-header">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            {? res.status == 1}
                            <li class="active"><a href="/competition/apply_info/{res.id}">{? res.form}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}참가신청 정보 설정</a></li>
                            ...
                            <li><a href="/competition/score_info/{res.id}">{? exn}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}심사위원 초대</a></li>
                            <li><a href="/competition/score_info/{res.id}">{? res.winner}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}수상자 선정</a></li>
                            {/}
                        </ul>
                     </div>
                    <div class="edit-body">   
                                ...
                                <form class="form-horizontal" role="form" name="info_form" method="post" onsubmit="return false;">
                                    <fieldset>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            {:}
                                            <p class="text-danger text-center">경진대회의 접수기간 이전에만 수정 할 수 있습니다.</p>
                                            {/}
                                        </div>
