                ...
                <div  class="row"> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 content editor">
                        ...
                        <div class="content-header">
                            <h3 class="content-heading"><a href="/member/edit_program_m">Benefit 관리</a> > 프로그램 운영 현황</h3> 
                        </div>
                        ...
                        <div class="well applied-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="/program/views/{res.id}">{res.subject}</a></h4>
                        ...
                        <div class="applied-list panel panel-default tab-content"> 
                            <div class="panel-heading">
                                ...
                                <!--a class="pull-right btn btn-default btn-xs" href="/program/applied_excel/{res.id}">참가자 리스트 다운로드</a-->
                                {/}
                            ...
                            <div class="panel-body tab-pane {? !tab}active{/}" id="apply_list">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cell-content">
                                                    <a href="/program/applied_view/{.id}" class="btn btn-default btn-xs">내용보기</a>
                                                </td>                       
                                            </tr>
                                            {/}
                                        </tbody>
                                ...
                                <div class="paging text-center">
                                    <ul class="pagination">
                                        ...
                                        {:}
                                        <li><a href="/program/applied_list/{res.id}/{page - 1}?alig={alig}">&laquo;</a></li>
                                        {/}
                                        ...
                                        {:}
                                        <li {?.type == "current"}class="active"{/}><a href="/program/applied_list/{res.id}/{.page}?alig={alig}" >{.page}</a></li>
                                        {/}
                                        {/}
                                        ...
                                        {:}
                                        <li><a href="/program/applied_list/{res.id}/{page + 1}?alig={alig}" >&raquo;</a></li>
                                        {/}
                                    </ul>
                                </div> 
                                <!-- /paging --> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        ...
                        <div class="panel writed-competition">
                            ...
                            <ul class="media-list post-list">
                                {@ m_list}
                                <li class="media"> {? .img}<a href="/program/views/{.id}" class="pull-left media-object"> <img class="img-responsive" src="{.img}"> </a>{/}
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="/program/views/{.id}">{.subject}</a></h4>
                        ...
                        <div class="panel applied-competition">
                            ...
                            <ul class="media-list post-list">
                                {@ a_list}
                                <li class="media"> {? .img}<a href="/program/views/{.cid}" class="pull-left media-object"> <img class="img-responsive" src="{.img}"> </a>{/}
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="/program/views/{.cid}">{.subject}</a></h4>
                                        <div class="media-meta"> <span class="author"><a href="/member/{.ids}">{.name}</a></span> <span class="time"><span class="icon-time"></span>&nbsp; {=trans_date_ago(.date_created)}</span> </div>
                                    </div>
                                    <!-- /media-content --> 
                                </li>
