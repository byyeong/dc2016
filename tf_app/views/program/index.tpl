...
$(document).ready(function(){ 
    ...
    { 
        ...
        document.location.href = "/program/"+_val+"/1?type={type}&order={order}";
    }); 
    $("select[name=type]").change(function() 
    { 
        var _val = $("select[name=type] option:selected").val();
        document.location.href = "/program/{status}/1?type="+_val+"&order={order}";
    });
    $("select[name=order]").change(function() 
    { 
        var _val = $("select[name=order] option:selected").val();
        document.location.href = "/program/{status}/1?type={type}&order="+_val;
    }); 
}); 
