                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 content">
                        ...
                        <div id="article">
                            ...
                            <div class="article-body">
                                ...
                                <dl class="dl-horizontal item-attach">
                                    <dt>첨부파일</dt>
                                    <dd><a href='/program/get_pr_source?ev={res.id}'>{res.filename}</a></dd>
                        ...
                        <div class="formApply" {? !res.app}style="display: none;"{/}>
                            ...
                            <div class="well text-center"> 
                                <div><a class="btn btn-primary" href="/program/applied_list/{res.id}">&nbsp; &nbsp; &nbsp; &nbsp; <span class="icon-hand-right"></span>&nbsp; 참가자 목록 보기 &nbsp; &nbsp; &nbsp; &nbsp; </a></div>
                            </div>
                            {:}
                            ...
                            {? !my}
                            <div class="well text-center"> 
                                <button class="btn btn-primary" onclick="location.href='/program/apply/{res.id}'">&nbsp; &nbsp; &nbsp; &nbsp; <span class="icon-hand-right"></span>&nbsp; 신청하기 &nbsp; &nbsp; &nbsp; &nbsp; </button>
                            </div>
                            {:}
                            <div class="well complete text-center"> 
                                ...
                                <a href="/program/apply/{res.id}/{my.id}" class="btn btn-default btn-sm">참가 신청 내용보기</a></div>
                            </div>
                            {/}
                            {:}
                            <div class="well text-center">  
                            ...
                            <div class="alert alert-info text-center">
                                <p>참가신청이 마감되었습니다.</p>
                                <a class="btn btn-default btn-sm" href="/program">프로그램 리스트 보기</a>
                            </div>
                            {/}    
                            {/}
                        </div>
