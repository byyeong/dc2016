...
$('#md-warning-ch .btn-danger').attr('onclick', 'javascript:location.href="/program/applied_list/{res.id}?tab=dashboard"');
                ...
                <div class="editor">
                    ...
                    <div class="edit-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li><a href="/program/edit/{res.id}">{? res}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}신청 정보 입력</a></li>
                            <li class="active"><a href="/program/apply_info/{res.id}">{? res.basic || res.forms || res.form_file}<span class="icon-ok-sign done"></span>{:}<span class="icon-ok todo"></span>{/}지원서 만들기</a></li>
                        </ul>   
