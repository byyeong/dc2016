<?php /* Template_ 2.2.4 2011/06/15 19:19:37 C:\tf8\tf_app\ext\tf_welcome\views\layout.tpl 000001621 */ ?>
...
<table cellpadding="10" cellspacing="0">
    <tr>
        <td colspan="2" style="font-size:12px;background-color:#000000;padding-top:20px;padding-bottom:5px;">
            <a href="/tf/"><font color="white" size="3"><b>Trail Framework</b></font></a>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td valign="top" style="font-size:12px;padding-left:20px;" width="700">
            <?php echo $TPL_VAR["contents_for_layout"]?>
